...
contract RevenueDistributor is AutomationCompatibleInterface, Ownable, ReentrancyGuard {
    ...
    function distributeRevenue(uint256 propertyId) public nonReentrant {
        ...
        // For ERC1155, we need to get the current supply from the token type info
        // This is a simplified approach - in a real implementation you'd track total supply differently
