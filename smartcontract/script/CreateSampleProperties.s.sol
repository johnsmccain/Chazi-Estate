...
contract CreateSampleProperties is Script {
    function run() external {
        ...
        uint256 property1 = factory.createProperty(
            "chazi-chain Luxury Apartment #1",
            "DEED-APT1",
            1000000 ether, // 1M USD value
            10000,   // 10k shares
            100 ether,     // $100 per share
        ...
        uint256 property2 = factory.createProperty(
            "chazi-chain Commercial Building #1",
            "DEED-COM1",
            5000000 ether, // 5M USD value
            50000,   // 50k shares
            100 ether,     // $100 per share
            "https://metadata.deedai.com/properties/2",
            true,     // Allows fractional ownership
            5000 ether, // rent price
            6000,     // loan to value (60%)
            400,      // interest rate (4%)
            700,      // expected return (7%)
            500 ether  // min investment
        );
        ...
        uint256 property3 = factory.createProperty(
            "chazi-chain Family Home #1",
            "DEED-HOME1",
            500000 ether,  // 500k USD value
            5000,    // 5k shares
            100 ether,     // $100 per share
            "https://metadata.deedai.com/properties/3",
            true,     // Allows fractional ownership
            800 ether, // rent price
            8000,     // loan to value (80%)
            600,      // interest rate (6%)
            900,      // expected return (9%)
            50 ether   // min investment
        );
