...
import { RainbowKitWalletConnection } from '../components/RainbowKitWalletConnection';

const RainbowKitWalletTestPage: React.FC = () => {
  ...
  const handleRefreshBalance = async () => {
    ...
    try {
      ...
      addLog(`Balance: ${balance} ${wallet.chainName === 'Hedera Testnet' ? 'HBAR' : 'ETH'}`);
    } catch (error) {
  ...
  const handleSwitchNetwork = async () => {
    addLog('Switching to Hedera Testnet...');
    try {
      await wallet.switchNetwork(296);
      addLog('Network switched to Hedera Testnet');
    } catch (error) {
      addLog(`Network switch error: ${error}`);
    }
  };
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <div className="bg-white/5 backdrop-blur-lg border border-white/20 rounded-2xl p-6">
        <h1 className="text-3xl font-bold text-white mb-6">RainbowKit Wallet Test</h1>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-white">
                  {wallet.accountBalance.toFixed(4)} {wallet.chainName === 'Hedera Testnet' ? 'HBAR' : 'ETH'}
                </span>
              </div>
              <div className="flex justify-between">
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-6">
          <h3 className="text-lg font-semibold text-white mb-3">RainbowKit Connect Button</h3>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-6">
          <h3 className="text-lg font-semibold text-white mb-3">Custom Wallet Component</h3>
          <RainbowKitWalletConnection variant="default" />
        </div>
        ...
        <div className="bg-blue-500/10 border border-blue-400/20 rounded-lg p-4">
          <h3 className="text-lg font-semibold text-blue-400 mb-2">RainbowKit Features</h3>
          <div className="text-blue-300 text-sm space-y-2">
            <p>✅ Multi-wallet support (MetaMask, WalletConnect, Coinbase, etc.)</p>
            <p>✅ Automatic network switching</p>
            <p>✅ Beautiful UI components</p>
            <p>✅ Built-in error handling</p>
            <p>✅ Mobile wallet support</p>
            <p>✅ Chain switching capabilities</p>
            <p>✅ Recent transactions display</p>
          </div>
        </div>
      </div>
    </div>
...
export default RainbowKitWalletTestPage;